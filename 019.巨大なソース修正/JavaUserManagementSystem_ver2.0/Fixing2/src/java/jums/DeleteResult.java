    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           Class.forName("com.mysql.jdbc.Driver").newInstance();
            ...
            db_st = db_con.prepareStatement("DELETE FROM user_t WHERE userID= ?");
            db_st.setInt(1,udd.getUserID());
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/deleteresult.jsp");
