 ...
 * @author guest1Day
 */
public class editconfirm1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            db_st = db_con.prepareStatement("INSERT INTO item_zaiko VALUES(?,?,?)");
            db_st.setString(1,request.getParameter("name"));
            int num1 = Integer.parseInt(request.getParameter("price"));
            db_st.setInt(2,num1);
